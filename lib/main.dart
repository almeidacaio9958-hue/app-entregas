...
class _OtimizeScreenState extends State<OtimizeScreen> {
  ...
  // Geocodificação: busca a latitude e longitude exata pelo nome da rua/endereço
  ...
  // Traçado real pelas ruas usando OSRM
  ...
  // Abre a navegação GPS curva a curva (Google Maps Navigation)
  Future<void> _startGpsNavigation(LatLng target, String address) async {
    final googleMapsNavUrl = Uri.parse('google.navigation:q=${target.latitude},${target.longitude}&mode=d');
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Endereço (Ex: Rua Vizeu 84, São Paulo)',
              ...
              isSearching
                  ...
                  : ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        // Localização real por Geocodificação
                        ...
                        if (coords == null) {
                          ...
                          final offset = (DateTime.now().millisecond % 30) * 0.001;
      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            // Ordena os pendentes pelo mais próximo da posição atual
            ...
            // Atualiza traçado real da rua
            if (waypoints.length > 1 && _streetRoutePoints.isEmpty) {
              ...
              markers.add(
                Marker(
                  ...
                  child: Container(
                    ...
                    child: const Center(
                      child: Icon(Icons.navigation, color: Color(0xFF1A73E8), size: 28),
                    ),
                  ),
                ),
              );
            ...
            for (int i = 0; i < list.length; i++) {
              ...
              markers.add(
                Marker(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: isDone ? Colors.green : const Color(0xFFEA4335),
                      shape: BoxShape.circle,
            ...
            return Column(
              children: [
                ...
                // MAPA (Estilo Google Maps CartoDB Positron / OSM)
                Expanded(
                  flex: 5,
                  child: Stack(
                    children: [
                      FlutterMap(
                        ...
                        children: [
                          // Estilo clean e nítido idêntico ao Google Maps
                          TileLayer(
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        // BOTÃO INICIAR NAVEGAÇÃO GPS CURVA A CURVA
                        if (nextStop != null) ...[
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: () {
                                ...
                                _startGpsNavigation(target, d['address'] ?? '');
                              },
                              icon: const Icon(Icons.navigation, color: Colors.white),
                              label: Text(
                                'INICIAR ROTA (Próxima: ${(nextStop.data() as Map<String, dynamic>)['address']})',
                                maxLines: 1,
                        ...
                        Expanded(
                          child: list.isEmpty
                              ? const Center(
                                  child: Text(
                                    'Nenhuma entrega cadastrada.\nToque no scanner ou no + para adicionar.',
                                    textAlign: TextAlign.center,
                                    ...
                                    return Dismissible(
                                      ...
                                      child: ListTile(
                                        ...
                                        leading: CircleAvatar(
                                          backgroundColor: isDone ? Colors.green : const Color(0xFF1A73E8),
                                          child: Text(
                                            '${index + 1}',
                                        ...
                                        trailing: Row(
                                          ...
                                          children: [
                                            IconButton(
                                              icon: const Icon(Icons.directions, color: Color(0xFF1A73E8)),
                                              onPressed: () => _startGpsNavigation(target, data['address'] ?? ''),
                                            ),
                                            IconButton(
                                              icon: Icon(
...
class PositionBarButton extends StatelessWidget {
  final VoidCallback onPressed;
  const PositionBarButton({super.key, required this.onPressed});
